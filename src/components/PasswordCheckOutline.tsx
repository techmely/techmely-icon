...
export interface PasswordCheckOutlineProps extends IconBaseProps {
  color?: string;
}

export const PasswordCheckOutline: React.FC<PasswordCheckOutlineProps> = (
  props: PasswordCheckOutlineProps
) =>
  GenIcon({
    tag: 'svg',
