...
export interface DotsVerticalOutlineProps extends IconBaseProps {
  color?: string;
}

export const DotsVerticalOutline: React.FC<DotsVerticalOutlineProps> = (
  props: DotsVerticalOutlineProps
) =>
  GenIcon({
    tag: 'svg',
