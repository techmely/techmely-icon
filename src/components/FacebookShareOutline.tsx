...
export interface FacebookShareOutlineProps extends IconBaseProps {
  color?: string;
}

export const FacebookShareOutline: React.FC<FacebookShareOutlineProps> = (
  props: FacebookShareOutlineProps
) =>
  GenIcon({
    tag: 'svg',
