...
export interface DotsHorizontalOutlineProps extends IconBaseProps {
  color?: string;
}

export const DotsHorizontalOutline: React.FC<DotsHorizontalOutlineProps> = (
  props: DotsHorizontalOutlineProps
) =>
  GenIcon({
    tag: 'svg',
