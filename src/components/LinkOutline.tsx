...
export interface LinkOutlineProps extends IconBaseProps {
  color?: string;
}

export const LinkOutline: React.FC<LinkOutlineProps> = (
  props: LinkOutlineProps
) =>
  GenIcon({
    tag: 'svg',
    ...
    child: [
      ...
      { tag: 'path', attr: { d: 'M13 11.25H11V12.75H13V11.25Z' } }
    ]
  })(props);
