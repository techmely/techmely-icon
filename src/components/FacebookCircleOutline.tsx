...
export interface FacebookCircleOutlineProps extends IconBaseProps {
  color?: string;
}

export const FacebookCircleOutline: React.FC<FacebookCircleOutlineProps> = (
  props: FacebookCircleOutlineProps
) =>
  GenIcon({
    tag: 'svg',
